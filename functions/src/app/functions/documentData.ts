...
function getPromocion(OUTPUT: OUTPUT, promotion: PromotionHabitat): any {
    ...
    return {
        ...
        promocionNumberViviendas: promotion && promotion.faseada ? promotion.promocionNumberViviendas : getNumberValue(OUTPUT.DATOSPRO, 'NUMVIV'),
        promocionNumberPlazas: promotion && promotion.faseada ? promotion.promocionNumberPlazas : getNumberValue(OUTPUT.DATOSPRO, 'NUMGAR'),
        promocionNumberLocales: promotion && promotion.faseada ? promotion.promocionNumberLocales : getNumberValue(OUTPUT.DATOSPRO, 'NUMLOC'),
        promocionNumberTrasteros: promotion && promotion.faseada ? promotion.promocionNumberTrasteros : getNumberValue(OUTPUT.DATOSPRO, 'NUMTRAS'),
        promocionNumberBicicletas: promotion && promotion.faseada ? promotion.promocionNumberBicicletas : getNumberValue(OUTPUT.DATOSPRO, 'NUMBICI'),
