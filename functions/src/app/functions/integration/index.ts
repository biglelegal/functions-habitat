...
import { createReservaService, fulfillReservaService } from './reserva';
...
app.put('/fulfillReserva/:documentUid', (request, response) => fulfillReservaService(request, response));
